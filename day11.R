...
lt$hour
lt$year+1900
as.POSIXct(1449894439,origin="1970-01-01")
...
gsub("[ABC]", "@", "123AunicoBCBC98ABC") # A,B,C한글자씩 @로 변경
gsub("ABC", "@", "123AunicoBCBC98ABC") # A,B,C 붙어있는 문자열(ABC)를 @로 변경
gsub("(AB)|C", "@", "123AunicoBCBC98ABC") # A,B,C (AB)문자열과 C를 @로 변경
gsub("A|(BC)", "@", "123AunicoBCBC98ABC") # A,B,C (BC)문자열과 A를 @로 변경
gsub("A|B|C", "@", "123AunicoBCBC98ABC") # A,B,C한글자씩 @로 변경 
